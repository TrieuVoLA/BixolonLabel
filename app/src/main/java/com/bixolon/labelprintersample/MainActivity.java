...
public class MainActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Button btnPrintview = (Button) findViewById(R.id.btnPrintview);

        final EditText edtText1 = (EditText) findViewById(R.id.edtText1);
        final EditText edtText2 = (EditText) findViewById(R.id.edtText2);
        final EditText edtText3 = (EditText) findViewById(R.id.edtText3);
        final EditText edtText4 = (EditText) findViewById(R.id.edtText4);


        btnPrintview.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (edtText1.getText().length() == 0) {
                    edtText1.setError("null");
                    return;
                }
                if (edtText2.getText().length() == 0) {
                    edtText2.setError("null");
                    return;
                }
                if (edtText3.getText().length() == 0) {
                ...
                command =
						...
						"BD5,5,320,232,B,5\n" +   //Box thikness 5
						"T50,20,4,1,1,0,0,N,N,'" + edtText1.getText().toString().trim() + "'\n" +    //text 1. (4)Font - 15 pt
						"B250,100,Q,2,M,4,0,'" + edtText2.getText().toString().trim() + "'\n" +        //Qr .
						"T50,200,2,1,1,0,0,N,N,'" + edtText3.getText().toString().trim() + "'\n" +        //text 3 (2)Font - 10 pt
						"P1";
                edtText4.setText(command);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.item2:
                ...
                alertBuilder.setTitle("Please select a printer to connect");
